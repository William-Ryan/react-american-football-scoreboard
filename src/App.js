    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={ e => sethomeScore(homeScore + 7 + 1) } className="homeButtons__touchdown">Home Touchdown</button>
          <button onClick={ e => sethomeScore(homeScore + 3) } className="homeButtons__fieldGoal">Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button onClick={ e => setawayScore(awayScore + 7 + 1) } className="awayButtons__touchdown">Away Touchdown</button>
